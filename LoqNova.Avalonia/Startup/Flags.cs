...
/// <summary>
/// Command-line startup flag parser. Logical copy of the WPF LoqNova.WPF.Flags so the
/// Avalonia UI preserves identical startup-argument semantics without depending on WPF.
/// </summary>
public class Flags
{
